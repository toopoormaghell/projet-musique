...
private:
    ...
    explicit Meta_Album(const QString& nom_album, const QString& nom_artiste, int annee, QImage& Poch, const QString& Type, const QList<Meta_Titre*>& titres, const QString& support_p, int id_album, int id_artiste, int id_poch, int id_type, int id_support_p, QObject* parent = NULL);
};
